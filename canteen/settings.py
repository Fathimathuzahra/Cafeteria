...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "canteen_app.context_processors.unread_notifications",  # ✅ add this
            ],
        },
    },
]
...
LOGOUT_REDIRECT_URL = 'login'  # or 'index' or any valid route name
...
# Currency settings
CURRENCY_SYMBOL = '₹'  # or '$' depending on your needs
CURRENCY_CODE = 'INR'